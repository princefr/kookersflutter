    ...
    return Material(
         ...
         child: Column(
           ...
           children: [
                  ...
                  Center(child: Text("Récapitulatif", style: GoogleFonts.montserrat(fontSize: 22))),

                  SizedBox(height: 30),

                  ListTile(
                    leading: Icon(CupertinoIcons.location_solid),
                    title: Text(databaseService.user.value.adresses.where((element) => element.isChosed == true).first.title, style: GoogleFonts.montserrat()),
                  ),
            ...
            SizedBox(height: 15),
              ...
              StreamButton(
                    ...
                    buttonText: "Payer" + " " + this.widget.order.totalWithFees + "€",
