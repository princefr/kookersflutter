...
class StreamButtonController {
  late ValueNotifier<StreamButtonState> status;
...
enum StreamButtonState { Normal, Loading, Success, Error }
...
class _StreamButtonState extends State<StreamButton> {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        ...
        builder:
            (BuildContext context, StreamButtonState state, Widget? child) {
                  ...
                  case StreamButtonState.Loading:
                    return Center(
                      child: ListTile(
                        ...
                        title: Text(this.widget.loadingText,
                  ...
                  case StreamButtonState.Error:
                    return ListTile(
                      ...
                      trailing: Container(
                          ...
                          width: 55,
                          child: Lottie.asset(
                              'assets/lottie/lf30_editor_g0zf4bru.json',
                              width: 45,
                              height: 45,
                              fit: BoxFit.fill,
                              repeat: false)),
                      title: Text(this.widget.errorText,
                          style: GoogleFonts.montserrat(
                              fontSize: 16,
                              color: Colors.black,
                              fontWeight: FontWeight.bold)),
                  ...
                  case StreamButtonState.Success:
                    return ListTile(
                      ...
                      trailing: Container(
                          ...
                          width: 55,
                          child: Lottie.asset(
                              'assets/lottie/lf30_editor_m8symrlg.json',
                              width: 45,
                              height: 45,
                              fit: BoxFit.fill,
                              repeat: false)),
                      title: Text(this.widget.successText,
                          style: GoogleFonts.montserrat(
                              fontSize: 16,
                              color: Colors.black,
                              fontWeight: FontWeight.bold)),
